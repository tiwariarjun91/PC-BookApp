...
type CPU struct {
	...
	NumberCores   uint32  `protobuf:"varint,3,opt,name=number_cores,json=numberCores,proto3" json:"number_cores,omitempty"`       // number of cores
	NumberThreads uint32  `protobuf:"varint,4,opt,name=number_threads,json=numberThreads,proto3" json:"number_threads,omitempty"` // number of threads
	MinGhz        float64 `protobuf:"fixed64,5,opt,name=min_ghz,json=minGhz,proto3" json:"min_ghz,omitempty"`                     // minimum frequency
	MaxGhz        float64 `protobuf:"fixed64,6,opt,name=max_ghz,json=maxGhz,proto3" json:"max_ghz,omitempty"`                     // maximum frequency
}
...
type GPU struct {
	...
	Menory *Memory `protobuf:"bytes,5,opt,name=menory,proto3" json:"menory,omitempty"`
}
...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x7a, 0x12, 0x1f, 0x0a, 0x06, 0x6d, 0x65, 0x6e, 0x6f, 0x72, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x07, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x52, 0x06, 0x6d, 0x65, 0x6e, 0x6f,
...
var file_processor_message_proto_depIdxs = []int32{
	2, // 0: GPU.menory:type_name -> Memory
